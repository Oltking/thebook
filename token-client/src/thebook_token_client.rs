...
pub struct ThebookTokenClientProgram;
impl sails_rs::client::Program for ThebookTokenClientProgram {}
pub trait ThebookTokenClient {
...
impl<E: sails_rs::client::GearEnv> ThebookTokenClient
    for sails_rs::client::Actor<ThebookTokenClientProgram, E>
{
    type Env = E;
    fn vft(&self) -> sails_rs::client::Service<vft::VftImpl, Self::Env> {
    ...
    fn faucet(&self) -> sails_rs::client::Service<faucet::FaucetImpl, Self::Env> {
        self.service(stringify!(Faucet))
    }
}
pub trait ThebookTokenClientCtors {
    type Env: sails_rs::client::GearEnv;
    ...
    fn new(
        ...
        decimals: u8,
        faucet_amount: U256,
    ) -> sails_rs::client::PendingCtor<ThebookTokenClientProgram, io::New, Self::Env>;
}
impl<E: sails_rs::client::GearEnv> ThebookTokenClientCtors
    for sails_rs::client::Deployment<ThebookTokenClientProgram, E>
{
    type Env = E;
    fn new(
        self,
        ...
        self.pending_ctor((name, symbol, decimals, faucet_amount))
    }
}

pub mod io {
    use super::*;
    sails_rs::io_struct_impl!(New (name: String, symbol: String, decimals: u8, faucet_amount: U256) -> ());
}
...
pub mod faucet {
    ...
    pub trait Faucet {
        ...
        fn has_claimed(
            &self,
            who: ActorId,
        ) -> sails_rs::client::PendingCall<io::HasClaimed, Self::Env>;
    }
    ...
    pub mod io {
        use super::*;
        sails_rs::io_struct_impl!(Claim () -> Result<U256, super::FaucetError>);
        sails_rs::io_struct_impl!(HasClaimed (who: ActorId) -> bool);
    }
}
